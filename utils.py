...
# PENTING: Baris "load_model" dihapus dari sini untuk menghemat memori.

# Mapping indeks ke label, ini sudah benar.
label_map = {
    0: 'Glioma',
    1: 'Meningioma',
    2: 'No Tumor',    
...
def dapatkan_hasil_prediksi(model, file_stream):
    """
    Fungsi utama untuk prediksi.
    Menerima: objek model Keras dan stream file gambar.
    Mengembalikan: nama kelas, skor kepercayaan, dan deskripsi.
    """
    # Membuka gambar dari stream file (langsung dari memori)
